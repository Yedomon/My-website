...
<p style="text-align:justify;">Hifiasm is incredibly fast. A total of **~18 mn** (system time) to assemble a **~430 Mb** [(**Yu et al., 2002**)](https://science.sciencemag.org/content/296/5565/79) genome with **32 cores**.</p>
...
<p style="text-align:justify;">The peak memory was also low **21.64 MB**, showing that Hifiasm is less memory consuming. The Hifiasm assembly size was **421 MB**, representing **97.90%** of the estimated size. Besides, the contiguity is incredibly high (N50 = 13.84 Mbp) compared to the recent Pacbio CLR, linkage mapping and fosmid-based assembly released by [**Du et al. (2017)**](https://www.nature.com/articles/ncomms15324).A basic comparison with the chromosomal-scale assemblies from CANU  and HERA assemblers with PacBio CLR data (Table 1) showed that the Hifiasm assembly is quite good for Hi-C scaffolding. </p>
